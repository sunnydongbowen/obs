...
![Pasted image 20230702100812.png](/img/user/Pasted%20image%2020230702100812.png)
# 3. channel
---
...
```
![Pasted image 20230702113108.png](/img/user/Pasted%20image%2020230702113108.png)
...
![Pasted image 20230702112833.png](/img/user/Pasted%20image%2020230702112833.png)
...
利用多返回值判断chan是否关闭，下面代码片段中的`f`函数会循环从通道`ch`中接收所有值，直到通道被关闭后退出。
```go
func f(ch chan int) {
	for {
		v, ok := <-ch
...
![Pasted image 20230702210139.png](/img/user/Pasted%20image%2020230702210139.png)
...
![Pasted image 20230702210643.png](/img/user/Pasted%20image%2020230702210643.png)
