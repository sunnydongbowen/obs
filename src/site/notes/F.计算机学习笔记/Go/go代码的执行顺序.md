---
{"dg-publish":true,"dg-permalink":"go代码的执行顺序","permalink":"/go代码的执行顺序/","noteIcon":"","created":"2023-01-12","updated":"2023-01-13"}
---
...
你可以看到，<font color="#92d050">这里 main 函数就主要是用来在包 pkg1 内部使用的，它是没法在包外使用的。</font>
